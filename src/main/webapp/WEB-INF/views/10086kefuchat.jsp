...
<head>
    ...
    <title>联系客服</title>
    <script type="text/javascript" src="static/jqueryChat/js/jquery.min.js"></script>
    <%--chatPage begin--%>
        ...
        <div class="chatBox-info">
            <div class="chatBox-list" ref="chatBoxlist">
                <div class="chat-list-people">
                    <div><img src="static/jqueryChat/img/icon01.png" alt="头像"/></div>
                    <div class="chat-name">
                        <p >客服10086</p>
                    </div>
                ...
                <div class="chatBox-content">
                    <div class="chatBox-content-demo" id="chatBox-content-demo">
                        ...
                        <div class="clearfloat">
                            ...
                            <div class="left">
                                <div class="chat-avatars"><img src="static/jqueryChat/img/icon01.png" alt="头像"/></div>
                                <div class="chat-message">
                                    <img src="static/jqueryChat/img/1.png" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="clearfloat">
                            ...
                            <div class="right">
                                ...
                                <div class="chat-avatars"><img src="static/jqueryChat/img/icon02.png" alt="头像"/></div>
                            </div>
                        </div>
    ...
    conn.listen({
        ...
        onTextMessage: function (message) {
            ...
            $(".chatBox-content-demo").append("<div class=\"clearfloat\">" +
                ...
                "<div class=\"left\"><div class=\"chat-avatars\"><img src=\"static/jqueryChat/img/icon01.png\" alt=\"头像\" /></div>  " +

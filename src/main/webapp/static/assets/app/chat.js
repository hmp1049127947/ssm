var App = function () {
    ...
    var handlerSendMessage = function (number,pwd) {
        var conn = {};
        ...
        conn.listen({
            ...
            onTextMessage: function (message) {
                ...
                $(".chatBox-content-demo").append("<div class=\"clearfloat\">" +
                    "<div class=\"author-name\"><small class=\"chat-date\">2017-12-02 14:26:58</small> </div> " +
                    "<div class=\"left\"> <div class=\"chat-message\"> " + message.sourceMsg + " </div> " +
                    "<div class=\"chat-avatars\"><img src=\"static/jqueryChat/img/icon01.png\" alt=\"头像\" /></div> </div> </div>");
    ...
    return {
        ...
        handlerSendMsg:function (number,pwd) {
            handlerSendMessage(number,pwd);
        }
    }

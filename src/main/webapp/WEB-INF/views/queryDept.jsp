...
<table id="dg" title="部门查询" style="width:99%;height:400px"
       toolbar="#toolbar" pagination="true" idField="id"
       rownumbers="true" fitColumns="true" singleSelect="true">
    <thead>
    <tr>
        <th field="name" width="50" editor="{type:'validatebox',options:{required:true}}">部门名称</th>
        <th field="remark" width="80%" editor="{type:'validatebox'}">部门简介</th>
    </tr>
    </thead>
</table>
<div id="toolbar">
